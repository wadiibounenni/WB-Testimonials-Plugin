...
class WB_Testimonials_Widget extends WP_Widget{
    public function __construct(){
        $widget_options = array(
            'description'   => __( 'Your most beloved testimonials', 'wb-testimonials' )
        );
        ...
        public function enqueue(){
            wp_enqueue_style(
                'wb-testimonials-style-css',
                WB_TESTIMONIALS_URL . 'assets/css/frontend.css',
                array(),
                WB_TESTIMONIALS_VERSION,
                'all'
            );
    }
    ...
    public function form( $instance ){
        ...
        ?>
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Title', 'wb-testimonials' ); ?>:</label>
                <input type="text" class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo esc_attr( $title ); ?>">
            </p>

            <p>
                <label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php esc_html_e( 'Number of testimonials to show', 'wb-testimonials' ); ?>:</label>
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id( 'image' ); ?>"><?php esc_html_e( 'Display user image?', 'wb-testimonials' ); ?></label>
            </p>
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id( 'occupation' ); ?>"><?php esc_html_e( 'Display occupation?', 'wb-testimonials' ); ?></label>
            </p>
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id( 'company' ); ?>"><?php esc_html_e( 'Display company?', 'wb-testimonials' ); ?></label>
            </p>
    ...
    public function widget( $args, $instance ){
        ...
        require( WB_TESTIMONIALS_PATH . 'views/wb-testimonials_widget.php' );
